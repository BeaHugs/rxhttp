...
public class RxNavigationBar extends LinearLayout {
    ...
    private RxNavigationBar.OnTabClickListener onTabClickListener;
    //消息红点字体大小
    ...
    //Add
    private RxNavigationBar.OnAddClickListener onAddClickListener;
    ...
    public RxNavigationBar(Context context) {
        super(context);

        initViews(context, null);
    }

    public RxNavigationBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.RxNavigationBar);
    ...
    private void parseStyle(TypedArray attributes) {
        if (attributes != null) {
            navigationHeight = attributes.getDimension(R.styleable.RxNavigationBar_Easy_navigationHeight, navigationHeight);
            navigationBackground = attributes.getColor(R.styleable.RxNavigationBar_Easy_navigationBackground, navigationBackground);


            tabTextSize = attributes.getDimension(R.styleable.RxNavigationBar_Easy_tabTextSize, tabTextSize);
            tabTextTop = attributes.getDimension(R.styleable.RxNavigationBar_Easy_tabTextTop, tabTextTop);
            iconSize = (int) attributes.getDimension(R.styleable.RxNavigationBar_Easy_tabIconSize, iconSize);
            hintPointSize = attributes.getDimension(R.styleable.RxNavigationBar_Easy_hintPointSize, hintPointSize);
            msgPointSize = attributes.getDimension(R.styleable.RxNavigationBar_Easy_msgPointSize, msgPointSize);
            hintPointLeft = attributes.getDimension(R.styleable.RxNavigationBar_Easy_hintPointLeft, hintPointLeft);
            msgPointTop = attributes.getDimension(R.styleable.RxNavigationBar_Easy_msgPointTop, -iconSize / 2);
            hintPointTop = attributes.getDimension(R.styleable.RxNavigationBar_Easy_hintPointTop, hintPointTop);

            msgPointLeft = attributes.getDimension(R.styleable.RxNavigationBar_Easy_msgPointLeft, -iconSize / 2);
            msgPointTextSize = attributes.getDimension(R.styleable.RxNavigationBar_Easy_msgPointTextSize, msgPointTextSize);
            addIconSize = attributes.getDimension(R.styleable.RxNavigationBar_Easy_addIconSize, addIconSize);
            addLayoutBottom = attributes.getDimension(R.styleable.RxNavigationBar_Easy_addLayoutBottom, addLayoutBottom);

            //加号属性
            addSelectTextColor = attributes.getColor(R.styleable.RxNavigationBar_Easy_addSelectTextColor, addSelectTextColor);
            addNormalTextColor = attributes.getColor(R.styleable.RxNavigationBar_Easy_addNormalTextColor, addNormalTextColor);
            addTextSize = attributes.getDimension(R.styleable.RxNavigationBar_Easy_addTextSize, addTextSize);
            addTextTopMargin = attributes.getDimension(R.styleable.RxNavigationBar_Easy_addTextTopMargin, addTextTopMargin);
            addAlignBottom = attributes.getBoolean(R.styleable.RxNavigationBar_Easy_addAlignBottom, addAlignBottom);


            lineHeight = attributes.getDimension(R.styleable.RxNavigationBar_Easy_lineHeight, lineHeight);
            lineColor = attributes.getColor(R.styleable.RxNavigationBar_Easy_lineColor, lineColor);


            addLayoutHeight = attributes.getDimension(R.styleable.RxNavigationBar_Easy_addLayoutHeight, navigationHeight + lineHeight);

            normalTextColor = attributes.getColor(R.styleable.RxNavigationBar_Easy_tabNormalColor, normalTextColor);
            selectTextColor = attributes.getColor(R.styleable.RxNavigationBar_Easy_tabSelectColor, selectTextColor);

            int type = attributes.getInt(R.styleable.RxNavigationBar_Easy_scaleType, 0);
            if (type == 0) {
            ...
            addLayoutRule = attributes.getInt(R.styleable.RxNavigationBar_Easy_addLayoutRule, addLayoutRule);
            hasPadding = attributes.getBoolean(R.styleable.RxNavigationBar_Easy_hasPadding, hasPadding);

            addAsFragment = attributes.getBoolean(R.styleable.RxNavigationBar_Easy_addAsFragment, addAsFragment);
...
//若没有设置中间添加的文字字体大小、颜色、则同其他Tab一样
    ...
    public RxNavigationBar addLayoutHeight(int addLayoutHeight) {
        this.addLayoutHeight = NavigationUtil.dip2px(getContext(), addLayoutHeight);
        return this;
    }

    public RxNavigationBar scaleType(ImageView.ScaleType scaleType) {
        this.scaleType = scaleType;
        return this;
    }


    public RxNavigationBar mode(int mode) {
        this.mode = mode;
        return this;
    }

    public RxNavigationBar hasPadding(boolean hasPadding) {
        this.hasPadding = hasPadding;
        return this;
    }

    public RxNavigationBar addIconSize(int addIconSize) {
 ...
 /*   public EasyNavigationBar onAddClickListener(EasyNavigationBar.OnAddClickListener onAddClickListener) {
    ...
    public RxNavigationBar navigationBackground(int navigationBackground) {
        this.navigationBackground = navigationBackground;
        return this;
    }

    public RxNavigationBar navigationHeight(int navigationHeight) {
        this.navigationHeight = NavigationUtil.dip2px(getContext(), navigationHeight);
        return this;
    }

    public RxNavigationBar normalTextColor(int normalTextColor) {
        this.normalTextColor = normalTextColor;
        return this;
    }

    public RxNavigationBar selectTextColor(int selectTextColor) {
        this.selectTextColor = selectTextColor;
        return this;
    }

    public RxNavigationBar lineHeight(int lineHeight) {
        this.lineHeight = lineHeight;
        return this;
    }

    public RxNavigationBar lineColor(int lineColor) {
        this.lineColor = lineColor;
        return this;
    }

    public RxNavigationBar tabTextSize(int tabTextSize) {
        this.tabTextSize = NavigationUtil.sp2px(getContext(), tabTextSize);
        return this;
    }

    public RxNavigationBar tabTextTop(int tabTextTop) {
        this.tabTextTop = NavigationUtil.dip2px(getContext(), tabTextTop);
        return this;
    }

    public RxNavigationBar msgPointTextSize(int msgPointTextSize) {
        this.msgPointTextSize = NavigationUtil.sp2px(getContext(), msgPointTextSize);
        return this;
    }

    public RxNavigationBar msgPointSize(int msgPointSize) {
        this.msgPointSize = NavigationUtil.dip2px(getContext(), msgPointSize);
        return this;
    }

    public RxNavigationBar msgPointLeft(int msgPointLeft) {
        this.msgPointLeft = NavigationUtil.dip2px(getContext(), msgPointLeft);
        return this;
    }

    public RxNavigationBar msgPointTop(int msgPointTop) {
        this.msgPointTop = NavigationUtil.dip2px(getContext(), msgPointTop);
        return this;
    }


    public RxNavigationBar hintPointSize(int hintPointSize) {
        this.hintPointSize = NavigationUtil.dip2px(getContext(), hintPointSize);
        return this;
    }

    public RxNavigationBar hintPointLeft(int hintPointLeft) {
        this.hintPointLeft = NavigationUtil.dip2px(getContext(), hintPointLeft);
        return this;
    }

    public RxNavigationBar hintPointTop(int hintPointTop) {
        this.hintPointTop = NavigationUtil.dip2px(getContext(), hintPointTop);
        return this;
    }


    public RxNavigationBar titleItems(String[] titleItems) {
        this.titleItems = titleItems;
        return this;
    }

    public RxNavigationBar normalIconItems(int[] normalIconItems) {
        this.normalIconItems = normalIconItems;
        return this;
    }

    public RxNavigationBar selectIconItems(int[] selectIconItems) {
        this.selectIconItems = selectIconItems;
        return this;
    }

    public RxNavigationBar fragmentList(List<Fragment> fragmentList) {
        this.fragmentList = fragmentList;
        return this;
    }

    public RxNavigationBar fragmentManager(FragmentManager fragmentManager) {
        this.fragmentManager = fragmentManager;
        return this;
    }

    public RxNavigationBar anim(Anim anim) {
        if (anim != null) {
    ...
    public RxNavigationBar addLayoutRule(int addLayoutRule) {
        this.addLayoutRule = addLayoutRule;
        return this;
    }

    public RxNavigationBar canScroll(boolean canScroll) {
        this.canScroll = canScroll;
        return this;
    }

    public RxNavigationBar smoothScroll(boolean smoothScroll) {
        this.smoothScroll = smoothScroll;
        return this;
    }


    public RxNavigationBar onTabClickListener(RxNavigationBar.OnTabClickListener onTabClickListener) {
        this.onTabClickListener = onTabClickListener;
        return this;
    }


    public RxNavigationBar iconSize(int iconSize) {
        this.iconSize = NavigationUtil.dip2px(getContext(), iconSize);
        return this;
    }

    public RxNavigationBar addLayoutBottom(int addLayoutBottom) {
        this.addLayoutBottom = NavigationUtil.dip2px(getContext(), addLayoutBottom);
        return this;
    }

    public RxNavigationBar addAsFragment(boolean addAsFragment) {
        this.addAsFragment = addAsFragment;
        return this;
    }

    public RxNavigationBar addCustomView(View customAddView) {
        this.customAddView = customAddView;
        return this;
    }

    public RxNavigationBar addTextSize(int addTextSize) {
        this.addTextSize = NavigationUtil.sp2px(getContext(), addTextSize);
        return this;
    }

    public RxNavigationBar addNormalTextColor(int addNormalTextColor) {
        this.addNormalTextColor = addNormalTextColor;
        return this;
    }

    public RxNavigationBar addSelectTextColor(int addSelectTextColor) {
        this.addSelectTextColor = addSelectTextColor;
        return this;
    }

    public RxNavigationBar addTextTopMargin(int addTextTopMargin) {
        this.addTextTopMargin = NavigationUtil.dip2px(getContext(), addTextTopMargin);
        return this;
    }

    public RxNavigationBar addAlignBottom(boolean addAlignBottom) {
    ...
    public RxNavigationBar.OnTabClickListener getOnTabClickListener() {
    ...
    public RxNavigationBar.OnAddClickListener getOnAddClickListener() {
