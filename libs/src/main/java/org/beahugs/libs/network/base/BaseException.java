...
public class BaseException extends Exception {
    ...
    public static BaseException handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            ex = new BaseException(e, ERROR.TIMEOUT_ERROR);
            ...
            ex = new BaseException(e, ERROR.NULL_POINTER_EXCEPTION);
            ex.message = "空指针异常";
        } else if (e instanceof javax.net.ssl.SSLHandshakeException) {
            ex = new BaseException(e, ERROR.SSL_ERROR);
            ex.message = "证书验证失败";
        } else if (e instanceof ClassCastException) {
            ex = new BaseException(e, ERROR.CAST_ERROR);
            ex.message = "类型转换错误";
            ...
            ex = new BaseException(e, ERROR.PARSE_ERROR);
            ex.message = "解析错误";
        } else if (e instanceof IllegalStateException) {
            ex = new BaseException(e, ERROR.ILLEGAL_STATE_ERROR);
            ex.message = e.getMessage();
        } else {
            ex = new BaseException(e, ERROR.UNKNOWN);
        }
        return ex;
    }
